                              ...
                              child: Padding(
                                ...
                                child: StreamBuilder<List<ToDoListRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<ToDoListRecord>
                                        textToDoListRecordList = snapshot.data;
                                    // Return an empty Container when the document does not exist.
                                    if (snapshot.data.isEmpty) {
                                      return Container();
                                    }
                                    final textToDoListRecord =
                                        textToDoListRecordList.isNotEmpty
                                            ? textToDoListRecordList.first
                                            : null;
                                    return Text(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  final toDoListCreateData =
                                    ...
                                    toDoDate: datePicked,
                                    toDoDescription: textController3.text,
                                    toDoName: valueOrDefault<String>(
                                  ...
                                  employeee =
                                      ToDoListRecord.getDocumentFromData(
                                          toDoListCreateData,
                                          toDoListRecordReference);
                                  Navigator.pop(context);
